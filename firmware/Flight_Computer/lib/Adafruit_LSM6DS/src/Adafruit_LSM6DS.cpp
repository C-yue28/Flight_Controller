...
*/
/**************************************************************************/
void Adafruit_LSM6DS_Gyro::getSensor(sensor_t_adafruit *sensor) {
  /* Clear the sensor_t object */
  memset(sensor, 0, sizeof(sensor_t_adafruit));
...
*/
/**************************************************************************/
void Adafruit_LSM6DS_Accelerometer::getSensor(sensor_t_adafruit *sensor) {
  /* Clear the sensor_t object */
  memset(sensor, 0, sizeof(sensor_t_adafruit));
...
*/
/**************************************************************************/
void Adafruit_LSM6DS_Temp::getSensor(sensor_t_adafruit *sensor) {
  /* Clear the sensor_t object */
  memset(sensor, 0, sizeof(sensor_t_adafruit));
